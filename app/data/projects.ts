...
export const projects: Project[] = [
  {
    ...
    tags: ['Chrome Extension', 'Privacy', 'Manifest V3', 'JavaScript'],
    link: 'https://github.com/simonecamerano/pii-guard-it',
    featured: true,
    ...
    caseStudy: {
      ...
      archFlow: [
        'Digitazione o paste',
        'Detector (regex + validatori)',
        'Pannello Shadow DOM',
        'Redactor (token reversibili)',
        'Testo offuscato inviato',
      ...
      ctaText: "Hai bisogno di uno strumento privacy-first su misura, che valida davvero i dati invece di indovinarli? Posso aiutarti a progettarlo.",
    },
  },
  {
    id: 3,
  ...
  },
  {
    ...
    caseStudy: {
      ...
      solution: {
        headline: "La soluzione: l'assistente interroga il database, non la propria memoria",
        text: "Il Terminale Zero Point riceve la domanda e, quando serve un dato, chiama uno strumento di ricerca sul database delle carte con i filtri che ha estratto dalla domanda: tipo, costo, statistiche, ordinamento. Sintetizza poi la risposta sui risultati veri, in streaming, restando dentro il personaggio. Se una carta non esiste, non la inventa: non la trova.",
        points: [
      ...
      archFlow: [
        ...
        "Terminale Zero Point",
        "Tool call con filtri",
        "Database carte (MongoDB)",
        "Claude Haiku 4.5",
      ...
      ctaText: "Hai dati strutturati che vorresti poter interrogare a voce, con risposte verificabili invece che plausibili? Posso aiutarti a costruirlo.",
    },
  },
]
