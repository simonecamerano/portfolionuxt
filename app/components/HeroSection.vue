  ...
  >
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-20 min-h-[calc(100svh-4rem)] grid lg:grid-cols-[0.9fr_1.1fr] gap-10 lg:gap-6 items-center">
      <div class="flex flex-col items-start relative z-20">
        ...
        <h1 v-motion :initial="reducedMotion ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }" :animate="{ opacity: 1, y: 0 }" :transition="reducedMotion ? { duration: 0 } : { duration: 0.7, delay: 0.08, ease: 'easeOut' }" class="motion-preload text-[clamp(2.75rem,5.2vw,5.1rem)] font-extrabold leading-[1.28] tracking-[-0.06em] text-[#f6f7fb] max-w-[690px]">
